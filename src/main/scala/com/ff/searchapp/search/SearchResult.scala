...
object SearchResult {
  ...
  implicit val userOptionShow: Show[Option[User]] = optionShow[User]
  implicit val vectorTicketShow: Show[Vector[Ticket]] = vectorShow[Ticket]
  ...
  implicit val showUserSearchResult: Show[UserSearchResult] =
    result => s"""
  ...
  implicit val showTicketSearchResult: Show[TicketSearchResult] =
    result => s"""
